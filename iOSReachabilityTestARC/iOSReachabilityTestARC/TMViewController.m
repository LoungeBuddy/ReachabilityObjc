...
@property(strong) ReachabilityObjc * googleReach;
@property(strong) ReachabilityObjc * localWiFiReach;
@property(strong) ReachabilityObjc * internetConnectionReach;
...
- (void)viewDidLoad
{
    ...
    self.googleReach.unreachableBlock = ^(ReachabilityObjc * reachability)
    {
    ...
    self.localWiFiReach = [ReachabilityObjc reachabilityForLocalWiFi];

    // we ONLY want to be reachable on WIFI - cellular is NOT an acceptable connectivity
    self.localWiFiReach.reachableOnWWAN = NO;

    self.localWiFiReach.reachableBlock = ^(ReachabilityObjc * reachability)
    {
    ...
    self.localWiFiReach.unreachableBlock = ^(ReachabilityObjc * reachability)
    {
    ...
    self.internetConnectionReach = [ReachabilityObjc reachabilityForInternetConnection];

    self.internetConnectionReach.reachableBlock = ^(ReachabilityObjc * reachability)
    {
    ...
    self.internetConnectionReach.unreachableBlock = ^(ReachabilityObjc * reachability)
    {
